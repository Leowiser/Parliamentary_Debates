...
## Data
To answer the question we need the data of the debates in the British parliament. To gather these parliamentary debates, we web scraped the debates in the House of Commons and Westminster hall from the *TheyWorkForYou* website. *TheyWorkForYou* is run by *mySociety* a British non for profit organization and aims to make the work of the Uk parliament more accessible and transparent to the wider public (cf. TheyWorkForYou, mySociety). In this capacity they also publish a mirrored version of *Hansard* the official webpage for transcripts of UK debates. 
