...
The following figures show the emotional polarity in the House of Commons during EU-related debates over time. The figures show the change in sentiments in different granularity - daily, quarterly and yearly. To make patterns more prevalent, we add smoothing lines as well to the plots.

The first plot below shows us the most granular view on sentiments, by the dates of the debates. While some fluctuation is inevitable in the sentiments, at first glance it seems like the emotional polarity moves in an even range around its average and we cannot see the increasing trend over time reported by Rheault et al. (2016). The speeches from the 6th March 2014 contained no lemmas from the lexicon 
```{r, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
