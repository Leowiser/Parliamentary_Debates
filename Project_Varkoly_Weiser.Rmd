...
author: "Adam Varkoly (r0823515), Leon Weiser (r0979317)"
output:
  html_document:
    df_print: paged
...
# Results
The following sections will show the found results of the sentiment analysis. First the temporal evolution of the sentiments is shown on a debate, quaterly, and yearly level. Then the difference between the sentiments of the Opposition and Government is looked at in more detail, and finally three main topics of the EU-UK relations are analysed.
